            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="{{ asset('images/portfolio/paysage1.jpg') }}" style="border-radius:7px;width:50%;height:200px" class="d-block   w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ asset('images/portfolio/paysage5.jpg') }}" style="border-radius:7px;width:50%;height:200px" class="d-block w-100" alt="...">
                  </div>
                  <div class="carousel-item">
                    <img src="{{ asset('images/portfolio/paysage6.jpg') }}" style="border-radius:7px;width:50%;height:200px" class="d-block w-100" alt="...">
                  </div>
                </div>
